...
-- ============================================================
MERGE INTO tr_chain_status (chn_sts_id, chn_sts_name) KEY (chn_sts_id) VALUES (1, 'ACTIVE');
MERGE INTO tr_chain_status (chn_sts_id, chn_sts_name) KEY (chn_sts_id) VALUES (2, 'SUSPENDED');
MERGE INTO tr_chain_status (chn_sts_id, chn_sts_name) KEY (chn_sts_id) VALUES (3, 'ENABLED');

-- ============================================================
-- Seed: Chain
-- ============================================================
MERGE INTO ts_chain (chn_id, chn_name, chn_description, chn_sts_id) KEY (chn_id)
VALUES (1, 'ORDER_PROCESSING', 'Order processing pipeline with configurable routing', 1);

-- ============================================================
-- Seed: Steps (reusable processing units)
-- ============================================================
MERGE INTO ts_step (stp_id, stp_name, stp_description) KEY (stp_id) VALUES (1,  'validateOrder',    'Validate order data (items, quantities, customer info)');
MERGE INTO ts_step (stp_id, stp_name, stp_description) KEY (stp_id) VALUES (2,  'checkInventory',   'Check stock availability for ordered items');
MERGE INTO ts_step (stp_id, stp_name, stp_description) KEY (stp_id) VALUES (3,  'processPayment',   'Process payment through payment gateway');
MERGE INTO ts_step (stp_id, stp_name, stp_description) KEY (stp_id) VALUES (4,  'applyDiscount',    'Apply loyalty and promotion discounts');
MERGE INTO ts_step (stp_id, stp_name, stp_description) KEY (stp_id) VALUES (5,  'calculateTax',     'Calculate applicable sales taxes');
MERGE INTO ts_step (stp_id, stp_name, stp_description) KEY (stp_id) VALUES (6,  'fulfillOrder',     'Pack items and arrange shipment');
MERGE INTO ts_step (stp_id, stp_name, stp_description) KEY (stp_id) VALUES (7,  'sendConfirmation', 'Send order confirmation notification');
